...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\readeroo on
     Windows, /home/user/dev/readeroo on Linux) in a file named
     readeroo@monsur.com and copy that file to
